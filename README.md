...
For the reported results, the Stage 1 and Stage 2 checkpoints were selected by validation channel F1 and classification weighted F1, respectively. Their test channel F1 scores are 0.7765 and 0.6938. Evaluate the provided Stage 1 checkpoint with:
